...
const LEGACY_LAST_EVENT_TIMESTAMP_KEY = 'rete_marketing_session_2_last_event_ts'
const LEGACY_LAST_EXTERNAL_REFERRER_KEY = 'rete_marketing_session_2_last_external_referrer'
const LEGACY_LAST_UTM_KEY = 'rete_marketing_session_2_last_utm'
const LEGACY_SESSION_ID_KEY = 'rete-marketing-session-2-id'

const LAST_EVENT_TIMESTAMP_KEY = 'rete_marketing_session_2_last_event_ts'
const LAST_EXTERNAL_REFERRER_KEY = 'rete_marketing_session_2_last_external_referrer'
const LAST_UTM_KEY = 'rete_marketing_session_2_last_utm'
const SESSION_ID_KEY = 'rete-marketing-session-2-id'
...
export const migrateMarketingSession2 = async () => {
