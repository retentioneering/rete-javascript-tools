...
const LEGACY_LAST_EVENT_TIMESTAMP_KEY = 'rete_marketing_session_1_last_event_ts'
const LEGACY_LAST_EXTERNAL_REFERRER_KEY = 'rete_marketing_session_1_last_external_referrer'
const LEGACY_LAST_UTM_KEY = 'rete_marketing_session_1_last_utm'
const LEGACY_SESSION_ID_KEY = 'rete-marketing-session-1-id'

const LAST_EVENT_TIMESTAMP_KEY = 'rete_marketing_session_1_last_event_ts'
const LAST_EXTERNAL_REFERRER_KEY = 'rete_marketing_session_1_last_external_referrer'
const LAST_UTM_KEY = 'rete_marketing_session_1_last_utm'
const SESSION_ID_KEY = 'rete-marketing-session-1-id'
...
export const migrateMarketingSession1 = async () => {
